...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/04/12 15:16:39 by nmariah           #+#    #+#             */
/*   Updated: 2026/04/12 15:20:55 by nmariah          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	is_double(t_stack *stack, int val)
{
	t_list	*tmp;
...
static int	check_arg(char *str, t_stack *a)
{
	long	x;
